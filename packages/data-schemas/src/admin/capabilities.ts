import { ResourceType, SystemCapabilities } from 'librechat-data-provider';
import type { BaseSystemCapability, TCustomConfig } from 'librechat-data-provider';

// ---------------------------------------------------------------------------
// System Capabilities
// ---------------------------------------------------------------------------

/* Re-exported from `librechat-data-provider` so the client and the server gate
 * on one definition of the base capability set. */
export { SystemCapabilities };
